...
public class SynchronousBufferFollowerEngineIntegrationTest {
    ...
    public void testBufferRollback() {
        ...
        FollowerEngine<TestFollower> engine1 = new SynchronousBufferFollowerEngine<>(buffer1, new TestFollower());
